	...
	function startIntro()
	{
		if (!initialized)
		{
			...
			if(FlxG.sound.music == null) {
				...
				FlxG.sound.playMusic(Paths.music('yourbestfriend'), 0);
		...
		dog = new FlxSprite(0, FlxG.height * 0.52).loadGraphic(Paths.image('tobyfox'));
		add(dog);
		dog.visible = false;
	...
	override function beatHit()
	{
		...
		if(!closedState) {
			...
			switch (sickBeats)
			{
				...
				case 3:
					#if PSYCH_WATERMARKS
					// addMoreText('Dancetrap', 15);
					addMoreText('and friends', 15);
				...
				case 5:
					...
					#else
					createCoolText(['Based off of the', 'indie game by'], -40);
					#end
				case 7:
					addMoreText('Toby Fox', -40);
					// ngSpr.visible = true;
					dog.visible = true;
				// credTextShit.text += '\nNewgrounds';
				case 8:
				...
				// credTextShit.text += '\nNight';
				case 15:
					addMoreText('Flowey'); // credTextShit.text += '\nFunkin';
