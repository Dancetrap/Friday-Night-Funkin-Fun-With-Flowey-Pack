...
class FreeplayState extends MusicBeatState
{
	...
	public function addSong(songName:String, weekNum:Int, songCharacter:String, color:Int, hideInFreePlay:Bool, isMysterySong:Bool)
	{
		songs.push(new SongMetadata(songName, weekNum, songCharacter, color, hideInFreePlay, isMysterySong));
	}
...
class SongMetadata
{
	...
	public function new(song:String, week:Int, songCharacter:String, color:Int, hide:Bool, mystery:Bool)
	{
		this.songName = song;
		this.week = week;
		this.songCharacter = songCharacter;
		this.color = color;
		this.hideInFreePlay = hide;
		this.isMysterySong = mystery;
